...
@section('dashboard')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Edit Trip Type</h1>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" value="{{ $tripType->name }}" class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-md-4" style="margin-top: 32px">
                                    <button type="submit" class="form-group form-control btn btn-info"> Save</button>
                                </div>
                            </div>
                        </div>
                    </form>
